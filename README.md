...
* *You also have a sql file called 'data.sql' with dummy data for testing.*
* *application-dev.properties uses environment variables to get the connection string*
